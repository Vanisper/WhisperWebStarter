    ...
    <a-layout class="layout" :class="{ mobile: appStore.hideMenu }">
        ...
        <a-layout>
            <a-layout style="background-color: var(--color-bg-2);">
                <a-layout-sider v-if="renderMenu" v-show="!hideMenu" class="layout-sider" breakpoint="xl"
...
const menuWidth = computed(() => {
    return appStore.menuCollapse ? 70 : appStore.menuWidth; // 48
});
...
.layout-content {
    // background-color: rgba(var(--blue-2)) !important;
