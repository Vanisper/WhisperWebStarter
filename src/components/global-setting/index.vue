<template>
    <div v-if="!appStore.navbar || (!appStore.navbar && appStore.layoutSetting)" class="fixed-settings" @click="setVisible">
    ...
    <a-drawer :width="300" unmount-on-close :visible="visible" :cancel-text="$t('settings.close')"
        ...
        <Block :options="themeOpts" title="主题样式" />
...
const contentOpts = computed(() => [
    ...
    { name: 'settings.routerTransition', key: 'routerTransition', defaultVal: appStore.routerTransition }
]);
const themeOpts = computed(() => [
    { title: '主题', key: 'themeStyle', defaultVal: undefined },
]);
